...
module type Map =
  sig
    ...
    val hash_fold_t: 'a data Base.Hash.folder -> 'a data t Base.Hash.folder
    ...
    val compare: ('a data -> 'b data -> int) -> 'a data t -> 'b data t -> int
    (** Total ordering between maps.  The first argument is a total ordering
        used to compare data associated with equal keys in the two maps. *)

    val equal: ('a data -> 'b data -> bool) -> 'a data t -> 'b data t -> bool
